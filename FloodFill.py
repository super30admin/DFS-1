...
'''BFS Solution'''
# Initially, I was maintaining a visited set. However, we do not need a visited set because
# we can use the image itself as our visited set because we are marking the newColor.
