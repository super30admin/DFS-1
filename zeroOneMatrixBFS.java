...
class Solution {
    public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
      ...
      //  q1.add(sr);
       // q1.add(sc);
        dfs(image, sr, sc, newColor, oldColor, r, c);
        
        return image;
    }
    private void dfs(int[][] image, int sr, int sc, int newColor, int oldColor, int r, int c){
                ...
                if(isValid(r,c,ndx,ndy)){
                    ...
                    if(image[ndx][ndy] == oldColor){
                        image[ndx][ndy] = newColor;
                          dfs(image, ndx, ndy, newColor, oldColor, r, c);
