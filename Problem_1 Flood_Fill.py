...
# Maintain neighbours at each level in the queue. Process each element in the queue one by one.
# If we encounter same color among neighbours, change it and add to the queue to consider its neighbours.
